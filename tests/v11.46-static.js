...
const cfg=JSON.parse(fs.readFileSync("public/resigres_2026_config.json","utf8"));assert(["2026-FR-v2","2026-FR-v3"].includes(cfg.version),`version Resigres incompatible: ${cfg.version}`);assert((cfg.verifiedAutomaticPricing?.showerTrayFamilies||[]).includes("Cosmo / Cosmo Contract"));
