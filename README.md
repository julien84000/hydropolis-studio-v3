...
## V11.34 — Ritmonio : fiches techniques officielles
- L'onglet officiel « Scheda tecnica » est maintenant reconnu comme PDF technique même si son URL `/download/?code=...` ne se termine pas par `.pdf`.
